    ...
    <div class="py-2 px-5 lg:px-10">
        <div class="flex justify-between items-center space-x-6">
            ...
            <div class="flex space-x-6 items-center">
                <div>
                    <a href="home.jsp">
                        <div class="text-sm bg-purple-600 text-white font-semibold rounded-md py-1.5 flex items-center px-4 space-x-2 hover:bg-purple-800 transition ease-in-out duration-300"><span class="font-bold">FPT</span>QnA Portal</div>
                    </a>
                </div>
                <div class="hidden md:block ">
                    <form action="Search" method="post" class="p-0 m-0 inline">
                        <div class="relative">
                            <input type="text" name="txtdisplayname" value="" class="text-sm py-1.5 w-60 rounded px-3 shadow focus:outline-none focus:ring-1 focus:ring-purple-500" placeholder="Search...">
            ...
            <div class="flex space-x-6 items-center">
                <div >
                    <button class="text-sm bg-purple-600 text-white font-semibold rounded-md py-1.5 flex items-center px-4 space-x-2 hover:bg-purple-800 transition ease-in-out duration-300">
                        <div>
                ...
                <div>
                        ...
                        <div class="relative text-left dropdown font-semibold">
                            ...
                            <div class="opacity-0 invisible dropdown-menu transition-all duration-300 transform origin-top-right -translate-y-2 scale-95">
                                <div class="absolute right-0 w-96 mt-2.5 origin-top-right bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg outline-none" aria-labelledby="headlessui-menu-button-1" id="headlessui-menu-items-117" role="menu">
                                    <div class="px-6 pt-8 pb-2">
                                        <p class="text-lg leading-5 font-bold">Notifications</p>
                                    </div>
                                    <div class="py-1 px-6 hover:bg-slate-100">
                                        <a href="personalprofile.jsp" class="text-gray-700 flex w-full pt-4 py-2 text-xs leading-5 text-left space-x-2"  role="menuitem" >
                                            ...
                                            <div>
                                                <div>Jane Dove<span class="font-normal"> has recently answered your question </span>"Why do birds fly, they want to look down on us or ..."</div>
                    ...
                    <div class="relative text-left dropdown font-semibold">
                        ...
                        <div class="opacity-0 invisible dropdown-menu transition-all duration-300 transform origin-top-right -translate-y-2 scale-95">
                            <div class="absolute right-0 w-56 mt-2 origin-top-right bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg outline-none" aria-labelledby="headlessui-menu-button-1" id="headlessui-menu-items-117" role="menu">
                                ...
                                <div class="py-1 px-4 hover:bg-slate-100">
                                    <a href="userManagement.jsp" class="text-gray-700 flex items-center w-full px-4 py-2 text-sm leading-5 text-left" role="menuitem" >
