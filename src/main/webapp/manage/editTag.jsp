...
<div class="container w-50% p-5 md:p-0 h-[100vh] mx-auto flex flex-col justify-center">
    ...
    <div class="w-full bg-white rounded-lg border border-gray-200 shadow-md p-8">
        <form action="/MainController">
            <input hidden name="action" value="EditTag"/>
            ...
            <div class="mb-6">
                ...
                <input type="title" id="title" name="tagName"
                       ...
                       placeholder="Tag's title here" value="<%=request.getParameter("tagName")%>" required>
            </div>
            <div class="mb-6">
                ...
                <textarea id="description" rows="4" name="description"
                          ...
                          placeholder="Explain something about the tag..." ><%=request.getParameter("description")%></textarea>
            </div>
            <button type="submit"
