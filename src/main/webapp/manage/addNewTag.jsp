...
<div class="container w-50% p-5 md:p-0 h-[100vh] mx-auto flex flex-col justify-center">
    <h3 class="text-2xl font-bold mb-5">Add a new tag</h3>
    <div class="w-full bg-white rounded-lg border border-gray-200 shadow-md p-8">
        <form action="/MainController" method="post">
            <input hidden name="action" value="AddTag"/>
            <div class="mb-6">
                <label for="title" class="block mb-2 text-sm font-medium text-gray-900">Title</label>
                <input type="title" id="title" name="tagName"
                       class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-purple-500 focus:border-purple-500 block w-full p-2.5"
                       placeholder="Tag's title here" required>
            </div>
            <div class="mb-6">
            ...
            <button type="submit"
                    class="text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Add
                new tag</button>
        </form>
    </div>
    <!-- Card footer start -->
