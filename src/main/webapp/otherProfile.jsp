    ...
    <div class="hidden md:block basis-4/12 h-full fixed left-4/12">
        <div class="flex flex-col items-center space-y-6">
            ...
            <div class="flex flex-col items-center">
                <div class="font-semibold text-lg">${requestScope.userProfile.name}</div>
                <div class="text-sm">${requestScope.userProfile.email}</div>
            </div>
            <div class="flex space-x-6 border-t border-b border-gray-300 pt-3 pb-3">
                <div class="flex flex-col">
                    <div class="font-semibold">${requestScope.userProfile.score}</div>
