                ...
                <div class="w-1/12 grid content-start pt-6 place-items-center font-semibold">
                    ...
                    <div class="w-11/12 bg-white p-8 grid content-start gap-y-3 rounded shadow-md">
                        <div class="flex gap-x-2 items-center">
                            <a href="#">
                                <img class="rounded h-8 w-8" src="${question.ownerAvt}">
                            </a>
                            <a href="#">
                                <span class="text-sm font-semibold">${question.ownerName}</span>
                            </a>
                            <span class="ml-4 text-xs text-[#B9C1CC]">${question.creationDate}</span>
                        </div>

<%--                        click to go to viewSingle question--%>

                        <a href="#">
                            <div class="font-semibold hover:opacity-60 duration-150">${question.title}</div>
                        </a>
                        <div class="text-gray-500 text-sm">${question.body}</div>
            ...
            <div class="pagination p-3 inline-flex space-x-3 sm:ml-20 ml-12">
                <a href="${pageContext.request.contextPath}/home?page=<%=previousPage%>" class="relative px-2 py-2 rounded border border-purple-600 text-sm font-medium text-gray-500 hover:bg-gray-50">
                ...
                <a href="${pageContext.request.contextPath}/home?page=<%=nextPage%>" class="relative px-2 py-2 rounded border border-purple-600 text-sm font-medium text-gray-500 hover:bg-gray-50">
