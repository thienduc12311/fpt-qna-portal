...
<div class="wrapper w-[100%] min-h-fit flex mt-[5%] items-center flex-col ">
    ...
    <div
        ...
        <!-- Content start -->
        <div class="mb-2">
            <p class="font-semibold text-xl mb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                eiusmod
                tempor
        ...
        <div class="flex text-xs gap-x-2 text-[#B9C1CC]">
            <a
                    class="cursor-pointer border border-[#B9C1CC] rounded px-4 py-1 font-medium hover:backdrop-brightness-95 duration-50">
                Java</a>
            <a
                    class="cursor-pointer border border-[#B9C1CC] rounded px-4 py-1 font-medium hover:backdrop-brightness-95 duration-50">
                Servlet</a>
        ...
        <div class="p-11">
            <div class="flex items-center mb-6 gap-x-3">
                <a href="" class="cursor-pointer">
                    <img class="w-9 rounded-full" src="https://www.w3schools.com/howto/img_avatar.png" alt="avatar"/>
                </a>
                <a href="" class="font-semibold text-[#505059]">
                    Author
                </a>
                <span class="text-xs text-[#B9C1CC] flex items-center">March 3, 2022</span>
            </div>
