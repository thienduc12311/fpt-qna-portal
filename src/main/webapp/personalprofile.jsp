    ...
    <div class="hidden md:block basis-4/12 h-full fixed left-4/12">
        <div class="flex flex-col items-center space-y-6">
            ...
            <div class="space-y-4">
                ...
                <div class="font-medium text-gray-400 hover:text-gray-500 duration-150"><a href="personalQuestion.jsp">Activity</a>
                </div>
                <div class="font-medium text-gray-400 hover:text-gray-500 duration-150"><a href="editprofile.jsp">Edit
                    Profile</a></div>
                <div class="font-medium text-gray-400 hover:text-gray-500 duration-150"><a href="changepassword.jsp">Change
                    Password</a></div>
            </div>
        </div>
    </div>
